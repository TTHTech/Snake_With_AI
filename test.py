...
class Snake(object):
    ...
    def move(self):
        ...
        if (len(self.positions) > 2 and new in self.positions[2:-1]) or new[0] == -GRIDSIZE or new[1] == -GRIDSIZE or \
...
class Node():
    ...
    def get_neighbors(self):
        ...
        for new_position in [UP, RIGHT, DOWN, LEFT]:
            ...
            if node_position[0] >= (GRID_HEIGHT - 1) or node_position[0] < 0 or node_position[1] >= (GRID_HEIGHT - 1) or \
                    node_position[1] < 0:
                continue
            ...
            if (grid[node_position[1], node_position[0]] == 1 or grid[node_position[1], node_position[0]] == 3 or (
                    grid[node_position[1], node_position[0]] == 4)):
                continue
...
def main():
    ...
    while (True):
        ...
        if snake.get_head_position() == food.get_position():
            ...
            print("NEW FOOD: (" + str(food.get_position()[0] / GRIDSIZE) + ", " + str(
                food.get_position()[1] / GRIDSIZE) + ")")
